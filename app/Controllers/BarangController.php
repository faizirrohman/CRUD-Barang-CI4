...
class BarangController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if (isset($getBarang)) {
            ...
            echo '<script>alert("ID barang '.$id.' Tidak ditemukan");window.location="'.base_url('barang').'"</script>';
        }
    }
    ...
    public function update()
    {
        ...
        echo '<script>alert("Sukses Edit Data Barang");window.location="'.base_url('barang').'"</script>';
    }
    ...
    public function hapus($id)
    {
        ...
        if (isset($getBarang)) {
            ...
            echo '<script>alert("Hapus Data Barang Sukses");window.location="'.base_url('barang').'"</script>';
        } else {
            echo '<script>alert("Hapus Gagal !, ID barang '.$id.' Tidak ditemukan");window.location="'.base_url('barang').'"</script>';
        }
    }
}